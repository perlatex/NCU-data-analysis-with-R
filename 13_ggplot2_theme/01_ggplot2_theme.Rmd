...
penguins %>% 
  ...
  theme(
    ...
    panel.grid.major.y = element_line(color = "blue", size = 1)
  )
```
...
|图例位置      | legend.position  |  "top", "bottom", "left", "right"  |
                                  |  "none", two-element numeric vector|
...
penguins %>% 
  ...
  theme(
    ...
    plot.background = element_rect(fill = "#FBCE74"),
